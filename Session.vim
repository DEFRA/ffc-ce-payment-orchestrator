...
badd +54 server/routes/paymentCalculation.js
badd +2 server/services/paymentCalculationService.js
badd +36 test/routes/paymentCalculation.integration.test.js
...
exe 'vert 4resize ' . ((&columns * 89 + 134) / 269)
exe '5resize ' . ((&lines * 18 + 30) / 60)
exe 'vert 5resize ' . ((&columns * 67 + 134) / 269)
exe '6resize ' . ((&lines * 18 + 30) / 60)
exe 'vert 6resize ' . ((&columns * 66 + 134) / 269)
exe '7resize ' . ((&lines * 18 + 30) / 60)
exe 'vert 7resize ' . ((&columns * 67 + 134) / 269)
exe '8resize ' . ((&lines * 18 + 30) / 60)
exe 'vert 8resize ' . ((&columns * 66 + 134) / 269)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
56
normal! zo
let s:l = 54 - ((19 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
16
normal! zo
let s:l = 19 - ((13 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
10
normal! zo
let s:l = 17 - ((16 * winheight(0) + 9) / 18)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
